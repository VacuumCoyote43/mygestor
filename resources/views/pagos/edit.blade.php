    ...
    <div class="col-md-12">
        <div class="card">
            <div class="card-header">
                <h5 class="mb-0"><i class="fas fa-money-bill-wave me-2"></i>Editar Pago</h5>
            </div>
            <div class="card-body">
                <form action="{{ route('pagos.update', $pago->id_pago) }}" method="POST">
                        ...
                        <select class="form-select @error('id_jugador') is-invalid @enderror" 
                            ...
                            @foreach($jugadores as $jugador)
                                <option value="{{ $jugador->id_jugador }}" 
                                        {{ old('id_jugador', $pago->id_jugador) == $jugador->id_jugador ? 'selected' : '' }}>
                        ...
                        <div class="col-md-6">
                            <div class="mb-3">
                                ...
                                <input type="number" step="0.01" min="0.01" 
                                       ...
                                       value="{{ old('importe_pago', $pago->importe_pago) }}" required>
                                @error('importe_pago')
                                    <div class="invalid-feedback">{{ $message }}</div>
                                @enderror
                            </div>
                    ...
                    <div class="alert alert-info">
                        ...
                        <strong>Nota:</strong> El saldo del jugador se actualizará automáticamente al guardar los cambios.
                    </div>
