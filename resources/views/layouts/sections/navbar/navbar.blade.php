    ...
    <div class="{{$containerNav}}">
      ...
      <div class="navbar-nav-right d-flex align-items-center" id="navbar-collapse">
        ...
        @if($configData['hasCustomizer'] == true)
          ...
          <!-- Layout Switcher -->
          <div class="navbar-nav align-items-center">
            <div class="nav-item dropdown-layout-switcher dropdown me-2 me-xl-0">
              <a class="nav-link btn btn-text-secondary btn-icon rounded-pill dropdown-toggle hide-arrow" href="javascript:void(0);" data-bs-toggle="dropdown">
                <i class='ti ti-layout-grid ti-md'></i>
              </a>
              <ul class="dropdown-menu dropdown-menu-start dropdown-layouts">
                <li>
                  <a class="dropdown-item" href="javascript:void(0);" data-layout="compact">
                    <span class="align-middle"><i class='ti ti-layout-list ti-md me-3'></i>Compact</span>
                  </a>
                </li>
                <li>
                  <a class="dropdown-item" href="javascript:void(0);" data-layout="wide">
                    <span class="align-middle"><i class="ti ti-layout-grid ti-md me-3"></i>Wide</span>
                  </a>
                </li>
              </ul>
            </div>
          ...
          <li class="nav-item navbar-dropdown dropdown-user dropdown">
            <a class="nav-link dropdown-toggle hide-arrow p-0" href="javascript:void(0);" data-bs-toggle="dropdown">
              <div class="avatar avatar-online">
                ...
                @else
                  <span class="avatar-initial rounded-circle bg-label-primary">{{ Auth::user()->name[0] ?? 'A' }}</span>
                @endif
              </div>
            </a>
